...
class CATSegHead(nn.Module):
    ...
    def forward(self, features, guidance_features, batched_inputs, prompt=None, gt_cls=None,need_loss=False):
        """
        Arguments:
            img_feats: (B, C, HW)
        ...
        return self.predictor(img_feat, guidance_features,batched_inputs, prompt, gt_cls,need_loss)