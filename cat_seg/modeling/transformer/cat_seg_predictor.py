...
class CATSegPredictor(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if clip_pretrained == "ViT-G" or clip_pretrained == "ViT-H":
            ...
            clip_model = eva_clip.create_model(model_name=clip_pretrained,  # EVA02-CLIP-B-16
    ...
    def forward(self, x, vis_guidance,batched_inputs, prompt=None, gt_cls=None,need_loss=False):
        ...
        text = text.repeat(x.shape[0], 1, 1, 1) # [5,20,1,512]
        
        out = self.transformer(x, text, vis,batched_inputs,need_loss)
        return out
